...
INSERT INTO `products` (`id`,`producto`,`url_imagen_producto`,`fecha_publicacion`,`user_id`,`categoria`,`nombre`,`marca`,`descripcion`,`comentarios`) VALUES (17,'botines predator mutator adidas negro oro blanco','/images/products/Botines-Predator-Mutator.jpg','2020-04-03',2,'Botines','Predator 20.1 Terreno Firme','Adidas','BOTINES PARA DOMINAR LAS CANCHAS DE TERRENO FIRME',2);
...
INSERT INTO `products` (`id`,`producto`,`url_imagen_producto`,`fecha_publicacion`,`user_id`,`categoria`,`nombre`,`marca`,`descripcion`,`comentarios`) VALUES (19,'botines nike phantom naranja negro ','/images/products/Botines-Nike-Phantom.jpg','2021-04-10',1,'Botines','Nike Phantom Vision Academy  Df Tf','Nike','Para ser el mejor en césped sintético',4);
INSERT INTO `products` (`id`,`producto`,`url_imagen_producto`,`fecha_publicacion`,`user_id`,`categoria`,`nombre`,`marca`,`descripcion`,`comentarios`) VALUES (20,'botines nike superfly negro ','/images/products/Botines-Nike-Superfly.jpeg','2021-04-15',1,'Botines','Nike Mercurial Superfly 7 Pro FG','Nike','Son pura pasión y potencia',4);
INSERT INTO `products` (`id`,`producto`,`url_imagen_producto`,`fecha_publicacion`,`user_id`,`categoria`,`nombre`,`marca`,`descripcion`,`comentarios`) VALUES (21,'botines nike mercurial naranja','/images/products/Botines-Nike-Mercurial.jpeg','2021-03-20',1,'Botines','Nike Mercurial Vapor 13','Nike','Basado en el análisis de los movimientos de los jugadores',2);
