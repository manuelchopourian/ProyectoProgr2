...
INSERT INTO `products` (`id`,`producto`,`url_imagen_producto`,`fecha_publicacion`,`user_id`,`categoria`,`nombre`,`marca`,`descripcion`,`comentarios`) VALUES (1,'camiseta local españa rojo','Camiseta-Espana-Local.jpeg','2021-04-21',4,'Camiseta','Local España','Adidas','LA CAMISETA DE LOCAL DE ESPAÑA, HECHA PARA LOS HINCHAS',0);
...
INSERT INTO `products` (`id`,`producto`,`url_imagen_producto`,`fecha_publicacion`,`user_id`,`categoria`,`nombre`,`marca`,`descripcion`,`comentarios`) VALUES (19,'botines nike phantom naranja negro ','Botines-Nike-Phantom.jpg','2021-04-10',1,'Botines','Nike Phantom Vision Academy  Df Tf','Nike','Para ser el mejor en césped sintético',0);
INSERT INTO `products` (`id`,`producto`,`url_imagen_producto`,`fecha_publicacion`,`user_id`,`categoria`,`nombre`,`marca`,`descripcion`,`comentarios`) VALUES (20,'botines nike superfly negro ','Botines-Nike-Superfly.jpeg','2021-04-15',1,'Botines','Nike Mercurial Superfly 7 Pro FG','Nike','Son pura pasión y potencia',0);
